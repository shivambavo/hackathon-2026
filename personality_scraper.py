#!/usr/bin/env python3
"""
Personality & Interests Scraper
Extracts personality traits, interests, hobbies, and what people post about
"""
import asyncio
import json
import re
...
class PersonalityScraper:
    ...
    async def save_personality_profile(self, profile: Dict[str, Any]) -> str:
        ...
        filename = f"extracted/{person_name.replace(' ', '_')}_personality_profile.json"
...
async def main():
    """Main function"""
    print("🧠 Personality & Interests Scraper")
    print("Extracts personality traits, interests, hobbies, and social preferences\n")
    ...
    async with PersonalityScraper() as scraper:
